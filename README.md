...
> Since January 2026, my active development work has been hosted primarily on my self-managed Gitea instance: [git.enuxia.fr](https://git.enuxia.fr).  
...
### [git.enuxia.fr](https://git.enuxia.fr)
...
[![Gitea](https://img.shields.io/badge/Gitea-git.enuxia.fr-green?logo=gitea)](https://git.enuxia.fr)
